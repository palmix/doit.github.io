...
g7_3_a = '1';
  ...
  g8_3_a = '1';
    ...
    var hasfileUpload = document.getElementById("fileUpload");
    hasfileUpload = hasfileUpload.value;
	var NewfileUpload ='';
   
   if(hasfileUpload.length <= 1 && g1 == ''){
   hasfileUpload = false;
   }else{
   hasfileUpload = true;
    }
...
var UserAccount = $("#UserAccountId").val();
  ...
  if(g2 == '' || hasfileUpload == false || UserAccount == 'NoData'){
