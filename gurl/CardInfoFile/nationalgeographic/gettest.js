...
set +="<button class='btn btn-primary btn-sm'onclick='yalla()'type='button'>yalla </button>";
set +="<button class='btn btn-primary btn-sm'onclick='getfromsheet()'type='button'>getfromsheet </button>";
set +="<button class='btn btn-primary btn-sm'onclick='setgetAll()'type='button'>setgetAll </button>";
set +="<button class='btn btn-primary btn-sm'onclick='gotonext()'type='button'>gotonext </button>";
set +="<button class='btn btn-primary btn-sm'onclick='sendcode()'type='button'>sendcode </button>";
...
var getusercode2 = "https://sheets.googleapis.com/v4/spreadsheets/1rkFhYrxZJ7VAZCb2Qz1JMdic7bNnSDLBx7tSVBDY8Rw/values/ajabanee?";
    ...
    var getIdCard = $('#numberFileSheet').val();
