...
cardsNum = cards1num;
    ...
    cards1.push('<div class="text-center mx-auto mt-2"><a onclick="startloding()" href="https://card.geoarabic.com/p/type.html?type=' + typelink + '" class="btn btn-dark mt-2 text-white">عرض كل ' + type + ' <span class="badge bg-danger">' + cardsNum + '</span></a></div></div>');
} else {
    cards1.push('</div>');
}
if (cards2num > 20) {
...
cardsNum = cards2num;
    ...
    cards2.push('<div class="text-center mx-auto mt-2"><a onclick="startloding()" href="https://card.geoarabic.com/p/type.html?type=' + typelink + '" class="btn btn-dark mt-2 text-white">عرض كل ' + type + ' <span class="badge bg-danger">' + cardsNum + '</span></a></div></div>');
} else {
    cards2.push('</div>');
}
if (cards3num > 20) {
...
cardsNum = cards3num;
    ...
    cards3.push('<div class="text-center mx-auto mt-2"><a onclick="startloding()" href="https://card.geoarabic.com/p/type.html?type=' + typelink + '" class="btn btn-dark mt-2 text-white">عرض كل ' + type + ' <span class="badge bg-danger">' + cardsNum + '</span></a></div></div>');
} else {
    cards3.push('</div>');
}
if (cards4num > 20) {
...
cardsNum = cards4num;
    ...
    cards4.push('<div class="text-center mx-auto mt-2"><a onclick="startloding()" href="https://card.geoarabic.com/p/type.html?type=' + typelink + '" class="btn btn-dark mt-2 text-white">عرض كل ' + type + ' <span class="badge bg-danger">' + cardsNum + '</span></a></div></div>');
} else {
    cards4.push('</div>');
}
if (cards5num > 20) {
...
cardsNum = cards5num;
    ...
    cards5.push('<div class="text-center mx-auto mt-2"><a onclick="startloding()" href="https://card.geoarabic.com/p/type.html?type=' + typelink + '" class="btn btn-dark mt-2 text-white">عرض كل ' + type + ' <span class="badge bg-danger">' + cardsNum + '</span></a></div></div>');
} else {
    cards5.push('</div>');
}
if (cards6num > 20) {
...
cardsNum = cards6num;
    ...
    cards6.push('<div class="text-center mx-auto mt-2"><a onclick="startloding()" href="https://card.geoarabic.com/p/type.html?type=' + typelink + '" class="btn btn-dark mt-2 text-white">عرض كل ' + type + ' <span class="badge bg-danger">' + cardsNum + '</span></a></div></div>');
} else {
    cards6.push('</div>');
}
if (cards7num > 20) {
...
cardsNum = cards7num;
    ...
    cards7.push('<div class="text-center mx-auto mt-2"><a onclick="startloding()" href="https://card.geoarabic.com/p/type.html?type=' + typelink + '" class="btn btn-dark mt-2 text-white">عرض كل ' + type + ' <span class="badge bg-danger">' + cardsNum + '</span></a></div></div>');
} else {
    cards7.push('</div>');
}
if (cards8num > 20) {
...
cardsNum = cards8num;
    ...
    cards8.push('<div class="text-center mx-auto mt-2"><a onclick="startloding()" href="https://card.geoarabic.com/p/type.html?type=' + typelink + '" class="btn btn-dark mt-2 text-white">عرض كل ' + type + ' <span class="badge bg-danger">' + cardsNum + '</span></a></div></div>');
} else {
    cards8.push('</div>');
}
