...
$("#SetSendSummary .SendAFile").html('إرسال الملف <div class="spinner-grow spinner-grow-sm text-primary" role="status"><span class="sr-only">إنتظار...</span></div>');
$("#SetSendSummary .SendAFile2").html('تحضير الملف <div class="spinner-border spinner-border-sm text-primary" role="status"><span class="sr-only">إنتظار...</span></div>');
