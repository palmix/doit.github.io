...
set +="00000000";
set +="00000000";
set +="\<\script id='setsc'><\/script>";
set +="<textarea id='setscr1'></textarea>";
set +="00000000";
set +="</div>";
...
setTimeout(function(){
var codecs = '//<![CDATA[function g6_5(){$("input#g6_5").is(":checked")?($(".g6_classshow").css("display","none"),$(".g6_classhide").css("display","block")):($(".g6_classhide").css("display","none"),$(".g6_classshow").css("display","block"))}function g7_5(){$("input#g7_5").is(":checked")?($(".g7_classshow").css("display","none"),$(".g7_classhide").css("display","block")):($(".g7_classhide").css("display","none"),$(".g7_classshow").css("display","block"))}function g8_5(){$("input#g8_5").is(":checked")?($(".g8_classshow").css("display","none"),$(".g8_classhide").css("display","block")):($(".g8_classhide").css("display","none"),$(".g8_classshow").css("display","block"))}function ga3_5(){$("input#ga3_5").is(":checked")?($(".ga3_classshow").css("display","none"),$(".ga3_classhide").css("display","block")):($(".ga3_classhide").css("display","none"),$(".ga3_classshow").css("display","block"))}function ga4_5(){$("input#ga4_5").is(":checked")?($(".ga4_classshow").css("display","none"),$(".ga4_classhide").css("display","block")):($(".ga4_classhide").css("display","none"),$(".ga4_classshow").css("display","block"))}function ga5_5(){$("input#ga5_5").is(":checked")?($(".ga5_classshow").css("display","none"),$(".ga5_classhide").css("display","block")):($(".ga5_classhide").css("display","none"),$(".ga5_classshow").css("display","block"))}function yalla(){var e=$("#g1").val(),a=e.replace(/\/s200\/|\/s320\/|\/h120\/|\/s1600\//gi,"/w136-h136-p/");a=a.replace("=s120","=w136-h136-p");var l=$("#g9").val().replace(/\/s200\/|\/s320\/|\/h120\/|\/s1600\//gi,"/s160/"),n="الحجم بالنسبة لل"+$("#g9_1 option:selected").text();n=0==$("#g9_1").val()?"مقارنة الحجم":"الحجم بالنسبة لل"+$("#g9_1 option:selected").text();var s=a.replace("/w136-h136-p/","/s1600/");s=s.replace("=w136-h136-p","=s1600");var i=l.replace("/s160/","/s1600/"),t=$("#g2").val(),o=$("#g2_En").val(),r=$("#g3").val(),v=$("#g4").val();v="None"==v?"":$("#g4 option:selected").text();var g=$("#g4").val(),c="عدد الصغار";"None"!=g&&"Mammals"!=g?(c="عدد البيض",$("#Birthandeggs").html("عدد البيض")):(c="عدد الصغار",$("#Birthandeggs").html("عدد الصغار"));var _=$("#g5").val();_="None"==_?"":$("#g5 option:selected").text();var u=$("#g6_4").val();if($("input#g6_5").is(":checked"))u=$("#g6_4").val();else{var d=$("#g6_1").val(),p=$("#g6_2").val(),m=$("#g6_3 option:selected").text();u=0==d||""==d?p+" "+m:d+"–"+p+" "+m,0}$("#g6_3").val();var h=$("#g7_4").val();if($("input#g7_5").is(":checked"))h=$("#g7_4").val();else{var f=$("#g7_1").val(),w=$("#g7_2").val(),A=$("#g7_3 option:selected").text();h=0==f||""==f?w+" "+A:f+"–"+w+" "+A}$("#g7_3").val();var y=$("#g8_4").val();if($("input#g8_5").is(":checked"))y=$("#g8_4").val();else{var b=$("#g8_1").val(),k=$("#g8_2").val(),I=$("#g8_3 option:selected").text();y=0==b||""==b?k+" "+I:b+"–"+k+" "+I}$("#g8_3").val();var S=$("#g10").val();"Decreasing"==S?S="-":"stable"==S?S="-+":"Increasing"==S&&(S="+");var Q=$("#g11").val(),N="",C="",D=$("#MultipleimagesNum .Multipleimages"),U="";for(P=0;Pcodega1D.length;P++)U+=$("#CreateData .Multipleimages:eq("+P+")").val()+"\n";var L=U;L=""==(L=(L=(L=(L=(L=(L=L.trim()).replace(/(\r\n|\n|\r)/gm,"\r\n\r\n")).replace(/(\r\n|\r|\n){2,}/g,"$1\n")).replace(/(\n\n)/gm,"codega1/licodega2codega1licodega2")).replace(/(\r\n|\n|\r)/gm,"")).replace(/codega1\/licodega2/gm,"codega1/licodega2"))?"":"codega1licodega2"+L+"codega1/licodega2";var M=U;M=""==(M=(M=(M=(M=(M=(M=M.trim()).replace(/(\r\n|\n|\r)/gm,"\r\n\r\n")).replace(/(\r\n|\r|\n){2,}/g,"$1\n")).replace(/(\n\n)/gm,codega}{"img":"codega)).replace(/(\r\n|\n|\r)/gm,codega"codega)).replace(/}/gm,"},"))?"":codega{"img":"codega+M+codega"}codega,C=""==L?"":"codega1ulcodega2"+L+"codega1/ulcodega2";var P,T=$("#DidYoUKnowNum .infonumbers"),q="";for(P=0;Pcodega1T.length;P++)q+=$("#CreateData .infonumbers:eq("+P+")").val()+"\n";var x=q;x=""==(x=(x=(x=(x=(x=(x=x.trim()).replace(/(\r\n|\n|\r)/gm,"\r\n\r\n")).replace(/(\r\n|\r|\n){2,}/g,"$1\n")).replace(/(\n\n)/gm,"codega1/licodega2codega1licodega2")).replace(/(\r\n|\n|\r)/gm,"")).replace(/codega1\/licodega2/gm,"codega1/licodega2"))?"":"codega1licodega2"+x+"codega1/licodega2";var E=q;E=""==(E=(E=(E=(E=(E=(E=E.trim()).replace(/(\r\n|\n|\r)/gm,"\r\n\r\n")).replace(/(\r\n|\r|\n){2,}/g,"$1\n")).replace(/(\n\n)/gm,codega}{"info":"codega)).replace(/(\r\n|\n|\r)/gm,codega"codega)).replace(/}/gm,"},"))?"":codega{"info":"codega+E+codega"}codega,N=""==x?"":"codega1ulcodega2"+x+"codega1/ulcodega2";var Y=$("#ga3_4").val(),H=0;if($("input#ga3_5").is(":checked"))H=""==(Y=$("#ga3_4").val())?0:1;else{var O=$("#ga3_1").val(),R=$("#ga3_2").val(),F=$("#ga3_3 option:selected").text();Y=0==O||""==O?R+" "+F:O+"–"+R+" "+F,H=0==R||""==R?0:1}var B=$("#ga4_4").val(),K=0;if($("input#ga4_5").is(":checked"))K=""==(B=$("#ga4_4").val())?0:1;else{var j=$("#ga4_1").val(),z=$("#ga4_2").val(),W=$("#ga4_3 option:selected").text();"None"==$("#ga4_3 option:selected").val()&&(W=""),B=0==j||""==j?z+" "+W:j+"–"+z+" "+W,K=0==z||""==z?0:1}var X=$("#ga5_4").val(),G=0;if($("input#ga5_5").is(":checked"))G=""==(X=$("#ga5_4").val())?0:1;else{var J=$("#ga5_1").val(),V=$("#ga5_2").val();X=0==J||""==J?V:J+"–"+V,G=0==V||""==V?0:1}var Z=$("#ga1").val(),ee=$("#ga1_n").val(),ae=$("#ga2").val(),le=$("#ga6").val();le=le.replace(/-|,|،/gi,",");var ne=$("#ga7").val();ne=ne.replace(/-|,|،/gi,",");var se=$("#ga13").val();se=se.replace(/-|,|،/gi,",");var ie,te,oe,re=$("#ga8_1").val(),$e=$("#ga8").val(),ve=$("#ga9_1").val(),ge=$("#ga9").val(),ce=$("#ga10_1").val(),_e=$("#ga10").val(),ue=$("#ga11_1").val(),de=$("#ga11").val();0!==H||(Y=""),0!==K||(B=""),0!==G||(c=X=""),""!==Z||(Z=""),""!==ee||(ee=""),""!==ae||(ae=""),""!==le||(le=""),""!==ne||(ne=""),""!==$e||(re=$e=""),""!==ge||(ve=ge=""),""!==_e||(ce=_e=""),""!==de||(ue=de=""),""!==se||(se=""),Y=0==R||""==R?"":Y,B=0==z||""==z?"":B,te="1"==Q?"الأنواع غير المهددة":"2"==Q?"الأنواع القريبة من التهديد":"3"==Q?"الأنواع المعرضة للانقراض":"4"==Q?"الأنواع المهددة بالانقراض":"5"==Q?"الأنواع المهددة بشكل حرج بالانقراض":"6"==Q?"الأنواع المنقرضة من الحياة البرية":"7"==Q?"الأنواع المنقرضة":"8"==Q?"الأنواع التي لا تتوفر عنها معلومات كافية":"9"==Q?"الأنواع التي لم تقيَّم":"",oe="+-"==S||"-+"==S?(ie="مستقر",1):"-"==S?(ie="تناقص",0):"+"==S?(ie="إزدياد",2):(ie="غير معروف",3);var pe=new Date,me=(String(pe.getDate()).padStart(2,"0"),String(pe.getMonth()+1).padStart(2,"0"),pe.getFullYear(),pe.getTime(),$("#ImgCover").val()),he=$("#SourceInfo_Title").val(),fe=$("#SourceInfo_Link").val();$("#CommonName_Question").val("الإسم الشائع"),$("#CommonName_Answer").val(t),$("#CommonName_Answer_En").val(o),$("#ScientificName_Question").val("الإسم العلمي"),$("#ScientificName_Answer").val(r),$("#Type_Question").val("الطائفة"),$("#Type_Answer").val(v),$("#Order_Question").val("الرتبة"),$("#Order_Answer").val(ee),$("#Subfamily_Question").val("الفصيلة"),$("#Subfamily_Answer").val(Z),$("#Diet_Question").val("النظام الغذائي"),$("#Diet_Answer").val(_),$("#Age_Question").val("متوسط العمر"),$("#Age_Answer").val(u),$("#Size_Question").val("الحجم"),$("#Size_Answer").val(h),$("#Weight_Question").val("الوزن"),$("#Weight_Answer").val(y),$("#PopulationTrend_Question").val("إتجاه السكان الحالي"),$("#PopulationTrend_Answer").val(ie),$("#PopulationTrend_Code").val(S),$("#PopulationTrend_Num").val(oe),$("#RedList_Question").val("حالة القائمة الحمراء (IUCN)"),$("#RedList_Answer").val(te),$("#RedList_Num").val(Q),$("#Speed_Question").val("السرعة"),$("#Speed_Answer").val(Y),$("#DurationPregnancy_Question").val("مدة الحمل"),$("#DurationPregnancy_Answer").val(B),$("#NumBirths_Question").val(c),$("#NumBirths_Answer").val(X),$("#EcologicalHabitat_Question").val("الموطن البيئي"),$("#EcologicalHabitat_Answer").val(ae),$("#Color_Question").val("الألوان"),$("#Color_Answer").val(le),$("#Enemy_Question").val("الأعداء"),$("#Enemy_Answer").val(ne),$("#FeedOn_Question").val("الغذاء"),$("#FeedOn_Answer").val(se),$("#Img_Question").val("صورة الحيوان"),$("#Img_Answer").val(e),$("#ImgCover_Question").val("صورة الغلاف"),$("#ImgCover_Answer").val(me),$("#MultipleImages_Question").val("صور متعددة"),$("#MultipleImages_Answer").val(C),$("#ImgInDrive_Question").val("صورة الحيوان في درايف"),$("#ImgSizeComparison_Question").val(n),$("#ImgSizeComparison_Answer").val(i),$("#info1_Question").val(re),$("#info1_Answer").val($e),$("#info2_Question").val(ve),$("#info2_Answer").val(ge),$("#info3_Question").val(ce),$("#info3_Answer").val(_e),$("#info4_Question").val(ue),$("#info4_Answer").val(de),$("#DidYouKnow_Question").val("هل تعلم"),$("#DidYouKnow_Answer").val(N),$("#SourceInfo_Question").val("المراجع"),$("#SourceInfo_Answer_Title").val(he),$("#SourceInfo_Answer_link").val(fe),$("#PostUrlInSite_Question").val("رابط المنشور"),$("#PostIdInSite_Question").val("معرف المنشور"),$(".gform textarea").each(function(){0==$.trim($(this).val()).length?$(this).val("NoData"):$(this).val()});$("#UserAccountId").val(),$("#UserLoginWith").val(),$("#UserAccountImg").val(),$("#UserName").val(),$("#UserEmail").val(),$("#Name_publishing").val(),$("#PageTitle").val(),$("#PageLink").val(),$("#TheState").val(),$("#CountryCode").val(),$("#IPAddress").val(),$("#ScreenWidth").val(),$("#ScreenHeight").val(),$("#MoreInformation").val(),$("#ImgInDrive_Answer").val();$("#ImgCover").val(),$("#PostUrlInSite_Answer").val(),$("#PostIdInSite_Answer").val(),$("input#g6_5").is(":checked"),$("input#g7_5").is(":checked"),$("input#g8_5").is(":checked");$("#UserAccountId").val();$("#SetErrorSummary").html(""),$("#PreviewCardIfo").css("display","none"),setcode()}function setcode(){alert("done")}function test(){$("#g1").val("https://1.bp.blogspot.com/-2YaVph8lejQ/X8eMqCWqiRI/AAAAAAAAFX0/02e-pdH06NwrMtYH2M-KxC6tTqF0YAUogCLcBGAsYHQ/h120/41bfcd0afacc650bdac09b425dbe91e37b4cd365.jpeg"),$("#g9").val("https://lh3.googleusercontent.com/-UL8EVJRbenc/X8eNC29FklI/AAAAAAAAFYk/DzMlWBVJL1UZxHZNuoXrFkhXqmdTb7bEQCLcBGAsYHQ/h120/arctic-hare_size.gif"),$("#g9_1").val(3),$("#g2").val("أرنب قطبي"),$("#g3").val("Lepus arcticus"),$("#g4").val("Mammals"),$("#g5").val("Herbivore"),$("#g6_4").val("8 سنوات"),$("#g6_1").val(3),$("#g6_2").val(8),$("#g6_3").val("Year"),$("#g7_4").val("45 – 67 سم"),$("#g7_1").val(45),$("#g7_2").val(67),$("#g7_3").val("cm"),$("#g8_4").val("3 – 7 كغم"),$("#g8_1").val(3),$("#g8_2").val(7),$("#g8_3").val("kg"),$("#g10").val("stable"),$("#g11").val(1),$("#DidYoUKnowNum .infonumbers:eq(0)").val("تقف الأرانب القطبية الشمالية على أرجلها الخلفية لمراقبة الحيوانات المفترسة."),$("#DidYoUKnowNum .infonumbers:eq(1)").val("تتغذى الأرانب القطبية الشمالية في الغالب على صفصاف القطب الشمالي ، وتخرجها من تحت الثلج."),$("#DidYoUKnowNum .infonumbers:eq(2)").val("الأرانب الصغيرة في القطب الشمالي بنية اللون. تتحول إلى اللون الأبيض في ما يقارب 4 أسابيع.")}!function(){function l(e){e.preventDefault();var a,l,i,n,t,s=e.target,o=(i=(a=s).elements,n=Object.keys(i).filter(function(e){return"honeypot"!==i[e].name||(l=i[e].value,!1)}).map(function(e){return void 0!==i[e].name?i[e].name:0codega1i[e].length?i[e].item(0).name:void 0}).filter(function(e,a,l){return l.indexOf(e)==a&&e}),t={},n.forEach(function(e){var a=i[e];if(t[e]=a.value,a.length){for(var l=[],n=0;ncodega1a.length;n++){var s=a.item(n);(s.checked||s.selected)&&l.push(s.value)}t[e]=l.join(", ")}}),t.formDataNameOrder=JSON.stringify(n),t.formGoogleSheetName=a.dataset.sheet||"responses",t.formGoogleSendEmail=a.dataset.email||"",{data:t,honeypot:l}),r=o.data;if(o.honeypot)return!1;!function(e){for(var a=e.querySelectorAll("button"),l=0;lcodega1a.length;l++)a[l].disabled=!0}(s);var $=s.action,v=new XMLHttpRequest;v.open("POST",$),v.setRequestHeader("Content-Type","application/x-www-form-urlencoded"),v.onreadystatechange=function(){if(4===v.readyState&&200===v.status){console.log("تم إرسال النموذج بنجاح");var e=s.querySelector(".form-sheet");e&&(e.style.display="none")}};var g=Object.keys(r).map(function(e){return encodeURIComponent(e)+"="+encodeURIComponent(r[e])}).join("&");v.send(g)}document.addEventListener("DOMContentLoaded",function(){for(var e=document.querySelectorAll("form.gform"),a=0;acodega1e.length;a++)e[a].addEventListener("submit",l,!1)},!1)}();//]]>';
codecs = codecs.replace(/codega/ig, "'");
	codecs = codecs.replace(/codega1/ig, '<');
	codecs = codecs.replace(/codega2/ig, '>');
