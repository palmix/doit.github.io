...
function ttesst(){
function getFormData(e){var t,n=e.elements,o=Object.keys(n).filter(function(e){return"honeypot"===n[e].name?(t=n[e].value,!1):!0}).map(function(e){return void 0!==n[e].name?n[e].name:n[e].length>0?n[e].item(0).name:void 0}).filter(function(e,t,n){return n.indexOf(e)==t&&e}),a={};return o.forEach(function(e){var t=n[e];if(a[e]=t.value,t.length){for(var o=[],r=0;r<t.length;r++){var l=t.item(r);(l.checked||l.selected)&&o.push(l.value)}a[e]=o.join(", ")}}),a.formDataNameOrder=JSON.stringify(o),a.formGoogleSheetName=e.dataset.sheet||"responses",a.formGoogleSendEmail=e.dataset.email||"",{data:a,honeypot:t}}function handleFormSubmit(e){e.preventDefault();var t=e.target,n=getFormData(t),o=n.data;if(n.honeypot)return!1;disableAllButtons(t);var a=t.action,r=new XMLHttpRequest;r.open("POST",a),r.setRequestHeader("Content-Type","application/x-www-form-urlencoded"),r.onreadystatechange=function(){if(4===r.readyState&&200===r.status){console.log("تم إرسال النموذج بنجاح");var e=t.querySelector(".form-sheet");e&&(e.style.display="none")}};var l=Object.keys(o).map(function(e){return encodeURIComponent(e)+"="+encodeURIComponent(o[e])}).join("&");r.send(l)}function loaded(){for(var e=document.querySelectorAll("form.gform"),t=0;t<e.length;t++)e[t].addEventListener("submit",handleFormSubmit,!1)}function disableAllButtons(e){for(var t=e.querySelectorAll("button"),n=0;n<t.length;n++)t[n].disabled=!0}document.addEventListener("DOMContentLoaded",loaded,!1);
}
