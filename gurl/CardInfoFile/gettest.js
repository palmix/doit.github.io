...
if(getc == 'الطائفة'){
    ...
    if (geta == 'حيوان عاشب' || geta == 'آكل أعشاب' || geta == 'آكل اعشاب' || geta == 'آكلة النبات' || geta == 'آكل النبات' || geta == 'عاشب' || geta == 'حيوانات عاشبة' || geta == 'آكل نبات' || geta == 'آكل نباتات' || geta == 'نباتي' || geta == 'عشبي') {
        ...
        $('#g5').val('Carnivore');
    } else if (geta == 'قارت' || geta == 'آكل النبات و الحيوان' || geta == 'آكل النبات والحيوان' || geta == 'آكلة الحيوان والنبات' || geta == 'آكل الحيوان والنبات' || geta == 'آكل الحيوان و النبات' || geta == 'حيوان قارت' || geta == 'قوارض' || geta == 'حيوان قارض'|| geta == 'آكل لحوم ونبات') {
        $('#g5').val('Omnivore');
