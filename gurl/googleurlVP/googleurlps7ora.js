! function(e) {
	...
	}, t.p = "/webapp/parse-google-photos-image/", t(t.s = 33)
}([function(e, t, n) {
	"use strict";
	(function(e) {
		function r() {
	...
	t.a = function() {
		var e = new r.a;
		if (null === document.location.origin.match(/ps-7ora\.alafdal\.net/)) throw new Error("Invalid origin.");
		e.set(a.a, ["//www.publicalbum.org/api/v2/webapp/parse-google-photos-image/jsonrpc"]), e.set(u.a, [a.a]);
		var t = window.defaultSharedLink || "https://photos.app.goo.gl/NzCtnnQGMzKzbhox5";
		return e.set(o.a, {
		...
		E = function(e) {
			...
			return o(t, e), w(t, [{
				...
				value: function() {
					...
					}, a.b.createElement("p", null, "Insert link to sharing of single image or video from Google Photos."), a.b.createElement("div", null, a.b.createElement(c.a, {
						box: !0,
						fullwidth: !0,
						label: "https://...",
					...
					}, "Get image/video url and code", this.state.loading ? String.fromCharCode(8230) : null)), a.b.createElement("div", {
					...
					}, "Copy url to clipboard")), a.b.createElement("div", {
						className: "app-code-block_dimmensions"
					}, a.b.createElement(c.a, {
						label: "Embed width",
						style: {
					...
					}, "Copy HTML code to clipboard"))), a.b.createElement(y.a, {
						ref: function(t) {
