...
if (titleDesc.length < 161 ){
	...
	titledescs = '<b class="text-danger">'+titleDesc.length+'</b>';
				...
				if (titleText !== ""){
					var pTitleLen = "<div class='table-responsive-xl'><table class='table table-bordered table-responsive-xl'><tr><th>العنوان</th><td>"+titles+" حرف.</td></tr>"; 
				}else{
					var pTitleLen = "<div class='table-responsive-xl'><table class='table table-bordered table-responsive-xl'>";
				}

				if (titleDesc !== ""){
					var pDescLen = "<tr><th scope='row'>الوصف</th><td scope='row'>" + titledescs + "  حرف.</td></tr></table></div>"; 
				}else{
					var pDescLen = "</table></div>";
				}
