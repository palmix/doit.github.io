...
window.onload = function() {
    var a;
    Init();
    document.getElementById("vsource").onclick = viewSource;
    document.getElementById("vsource2").onclick = viewSource;
};
...
function viewSource() {
    ...
    if (viewToggle == 1) {
        ...
        document.getElementById("vsource2").style.display = "block";
		...
		//NEW bits
		htmlText = htmlText.replace(new RegExp("<b>", "gi"), "<strong>");
		htmlText = htmlText.replace(new RegExp("</b>", "gi"), "</strong>");
		htmlText = htmlText.replace(new RegExp("<i>", "gi"), "<em>");
		htmlText = htmlText.replace(new RegExp("</i>", "gi"), "</em>");
		...
		htmlText2 = htmlText2.replace(new RegExp("x---rn---x", "gi"), "<br />\n");
		htmlText2 = htmlText2.replace(new RegExp(" <p>", "i"), "<p>");
		htmlText2 = htmlText2.replace(new RegExp("<br />", "gi"), "");
		
			var btncopy = document.getElementById("buttoncopy");
btncopy.setAttribute('data-clipboard-text',htmlText2);
