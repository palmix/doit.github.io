	...
	if(selectfontfamily == selectfontfamilycells){
		...
		document.getElementById('PreviewTable').style.display = 'block';
			  ...
			  if (StyleMode == 'FixedHeader') {
                ...
                newTableStyle.innerHTML = '<style type="text/css">.table100{color:#fff;width:100%;border-width:1px;border-color:#0e0e0e;border-collapse:collapse}.table100 th{font-family:initial;color:#fff;font-size:13px;background-color:#565656;border-width:1px;border-style:solid;border-color:#0e0e0e;padding:8px}.table100 tr{background-color:#fff}.table100 td{font-size:12px;font-family:initial;border-width:1px;border-style:solid;border-color:#0e0e0e;padding:8px;color:#3e3e3e}.table100 tr:hover{background-color:#d1edff}.table100 tr td:hover{background-color:#a8d7ff}'+columnnum+'</style>';
