...
$('#DesignInfo').html('<div class="alert alert-info mt-4" role="alert"><h5 class="alert-heading">'+stylename+'</h5><hr><div class="p-0 row"><div class="p-0 col-6">This design was created by <strong>'+name+'</strong> on <strong>'+published+'</strong></div><div class="p-0 col-6"><div class="input-group input-group-sm mb-3"><div class="input-group-prepend"><button class="btn btn-primary copy" data-clipboard-target="#urlstyle" type="button">Copy</button></div><input class="form-control" id="urlstyle" placeholder="" readonly value="'+valuelink+'"></div></div></div></div>');
