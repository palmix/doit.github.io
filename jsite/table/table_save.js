...
listusercode +='<div onclick="jumpto(&#039;newTableStyle&#039;);" class="input-group-append"><button class="btn btn-primary px-1 py-1 setstyle"data-id="'+idrep+'"type="button" aria-label="Close" data-dismiss="modal">Set Style</button></div>';
